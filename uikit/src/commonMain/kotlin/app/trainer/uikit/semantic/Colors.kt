...
fun lightAppColors(): AppColors = AppColors(
    ...
    borderStrong = Color(0xFF8C8881),
    textPrimary = Color(0xFF1A1917),
    textSecondary = Color(0xFF514E49),
    textMuted = Color(0xFF6F6B65),
    ...
    success = Color(0xFF2C7854),
    successSoft = Color(0xFFE2F0E8),
    warning = Color(0xFF8E6419),
...
fun darkAppColors(): AppColors = AppColors(
    ...
    borderStrong = Color(0xFF706E6B),
    textPrimary = Color(0xFFF2F0EC),
    textSecondary = Color(0xFFB3AFA9),
    textMuted = Color(0xFF8E8B87),
