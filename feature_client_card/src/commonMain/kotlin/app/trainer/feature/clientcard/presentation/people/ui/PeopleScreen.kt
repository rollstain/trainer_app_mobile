...
import app.trainer.media.rememberShareSheet
...
import app.trainer.strings.people_invite_share_text
...
private suspend fun handleSideEffect(
    ...
    when (effect) {
        ...
        is PeopleSideEffect.InviteCreated -> {
            copyToClipboard(effect.code)
            shareText(getString(Res.string.people_invite_share_text, effect.code))
        }
